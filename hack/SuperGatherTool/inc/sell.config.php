<?php
// b2b²úÆ·¹©Ó¦Ä£¿é - ²É¼¯ÅäÖÃÎÄ¼þ
// ¹¦ÄÜ£ºÆë²© b2b²úÆ·¹©Ó¦Ä£¿é µÄ²É¼¯ÅäÖÃ³ÌÐò£¬¿ÉÒÔÁé»î´¦Àí²É¼¯µÄÄÚÈÝ
...
$price = $price ? $price : 0; //¼Û¸ñ
$gather_module_valeDB[my_units] = $my_units?$my_units:"¼þ"; //¼ÆÁ¿µ¥Î»
$gather_module_valeDB[order_min] = $order_min?$order_min:rand(50, 1000); //×îÐ¡Æð¶©
$gather_module_valeDB[order_max] = $order_max?$order_max:rand(500, 10000); //×î´ó¹©»õ
$gather_module_valeDB[shoptype] = $shoptype?$shoptype:"¼ûÏêÏ¸ÃèÊö"; //ÐÍºÅ
$gather_module_valeDB[send_day] = $send_day?$send_day:"3-7ÌìÄÚ·¢»õ"; //·¢»õÆÚÏÞ
...
$end_day = date("Y-m-d", $endtime); //½áÊøÊ±¼ä

$picnum = count($Filedb); //ÎÄÕÂÍ¼Æ¬ÊýÁ¿
