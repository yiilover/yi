<?php
// ·¿²úÄ£¿é - ²É¼¯ÅäÖÃÎÄ¼þ
// ¹¦ÄÜ£ºÆë²©·¿²úÄ£¿éµÄ²É¼¯ÅäÖÃ³ÌÐò£¬¿ÉÒÔÁé»î´¦Àí²É¼¯µÄÄÚÈÝ
...
$gather_module_valeDB[acreage] = $acreage?$acreage:"¼ûÏêÏ¸ÃèÊö";
$gather_module_valeDB[fitment] = $fitment?$fitment:"¼ûÏêÏ¸ÃèÊö";
$gather_module_valeDB[floor] = $floor?$floor:"¼ûÏêÏ¸ÃèÊö";
...
$gather_module_valeDB[acreage]=$gather_module_valeDB[acreage]?$gather_module_valeDB[acreage]:"¼ûÏêÏ¸ÃèÊö";
$gather_module_valeDB[fitment]=$gather_module_valeDB[fitment]?$gather_module_valeDB[fitment]:"¼ûÏêÏ¸ÃèÊö";
$gather_module_valeDB[floor]=$gather_module_valeDB[floor]?$gather_module_valeDB[floor]:"¼ûÏêÏ¸ÃèÊö";
