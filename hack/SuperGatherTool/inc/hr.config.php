<?php 
// ÈË²ÅÕÐÆ¸Ä£¿é - ²É¼¯ÅäÖÃÎÄ¼þ
// ¹¦ÄÜ£ºÆë²© ÈË²ÅÕÐÆ¸Ä£¿é µÄ²É¼¯ÅäÖÃ³ÌÐò£¬¿ÉÒÔÁé»î´¦Àí²É¼¯µÄÄÚÈÝ
...
$gather_module_valeDB[nums] = $nums?$nums: rand(3, 20); //ÕÐÆ¸ÈËÊý
$gather_module_valeDB[wageyear] = $wageyear?$wageyear: rand(0, 3); //¹¤×÷¾­Ñé
$gather_module_valeDB[asksex] = $asksex?$asksex: 0; //ÐÔ±ðÒªÇó 0 ²»ÏÞ
$gather_module_valeDB[schoo_age] = $schoo_age?$schoo_age: rand(3, 8); //Ñ§ÀúÒªÇó
$gather_module_valeDB[wage] = $wage?$wage:  -1; //´ýÓö -1 ÃæÒé
$gather_module_valeDB[workplace] = $workplace?$workplace: '²»ÏÞ'; //´ýÓö -1 ÃæÒé
