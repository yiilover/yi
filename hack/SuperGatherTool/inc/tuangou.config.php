<?php 
// ÍÅ¹ºÄ£¿é - ²É¼¯ÅäÖÃÎÄ¼þ
// ¹¦ÄÜ£ºÆë²© ÍÅ¹ºÄ£¿é µÄ²É¼¯ÅäÖÃ³ÌÐò£¬¿ÉÒÔÁé»î´¦Àí²É¼¯µÄÄÚÈÝ
...
$sortid = 1; //ÍÅ¹ºÐÔÖÊ 1 ÍøÓÑ×Ô·¢×éÖ¯ 2 ¹Ù·½ÍÅ¹º×éÖ¯
$place = '²Î¼ûÏêÏ¸ÄÚÈÝ'; //»î¶¯µØµã
$jointime = date("Y-m-d", $posttime); //¿ªÊ¼Ê±¼ä
$end_time = date("Y-m-d", $endtime); //½áÊøÊ±¼ä
