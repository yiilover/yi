...
<table width='100%' border='1' cellpadding='0' cellspacing='0' bordercolor='#99CCFF' >
  ...
  <tr>
    <td><font color='#FF0000' title='点击即可实现复制' onClick='javascript:CopyText(this);'>{room_type=*}</font></td>
    <td>室内布局</td>
    <td>详细请根据入库模型自定义字段部分设置</td>
  </tr>
  <tr>
    <td><font color='#FF0000' title='点击即可实现复制' onClick='javascript:CopyText(this);'>{peitao=*}</font></td>
    <td>配套设施</td>
    <td>详细请根据入库模型自定义字段部分设置</td>
  </tr>
  <tr>
    <td><font color='#FF0000' title='点击即可实现复制' onClick='javascript:CopyText(this);'>{acreage=*}</font></td>
    <td>室内面积</td>
    <td>详细请根据入库模型自定义字段部分设置</td>
  </tr>
  <tr>
    <td><font color='#FF0000' title='点击即可实现复制' onClick='javascript:CopyText(this);'>{floor=*}</font></td>
    <td>所在楼层</td>
    <td>详细请根据入库模型自定义字段部分设置</td>
  </tr>
  <tr>
    <td><font color='#FF0000' title='点击即可实现复制' onClick='javascript:CopyText(this);'>{fitment=*}</font></td>
    <td>装修情况</td>
    <td>详细请根据入库模型自定义字段部分设置</td>
  </tr>
  <tr>
    <td><font color='#FF0000' title='点击即可实现复制' onClick='javascript:CopyText(this);'>{station=*}</font></td>
    <td>附近公交站</td>
    <td>详细请根据入库模型自定义字段部分设置</td>
  </tr>
  <tr>
    <td><font color='#FF0000' title='点击即可实现复制' onClick='javascript:CopyText(this);'>{bus=*}</font></td>
    <td>公交路线</td>
    <td>详细请根据入库模型自定义字段部分设置</td>
  </tr>
  <tr>
