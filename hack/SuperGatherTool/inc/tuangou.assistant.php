<?php 
// 团购模块 - 采集助手
// 功能：齐博 团购模块 的采集通配符说明，实现采集规则助手功能
...
<table width='100%' border='1' cellpadding='0' cellspacing='0' bordercolor='#99CCFF' >
  ...
  <tr>
    <td><font color='#FF0000' title='点击即可实现复制' onClick='javascript:CopyText(this);'>{jointime=*}</font></td>
    <td>开始时间</td>
    <td>默认值:采集时的时间</td>
  </tr>
  <tr>
    <td><font color='#FF0000' title='点击即可实现复制' onClick='javascript:CopyText(this);'>{end_time=*}</font></td>
    <td>结束时间,有效期</td>
    <td>默认值:30天后结束</td>
  </tr>
  <tr>
    <td><font color='#FF0000' title='点击即可实现复制' onClick='javascript:CopyText(this);'>{place=*}</font></td>
    <td>活动地点</td>
