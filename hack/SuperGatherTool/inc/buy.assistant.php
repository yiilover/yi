<?php 
// b2b求购模块 - 采集助手
// 功能：齐博 b2b求购模块 的采集通配符说明，实现采集规则助手功能
...
<table width='100%' border='1' cellpadding='0' cellspacing='0' bordercolor='#99CCFF' >
  ...
  <tr>
    <td><font color='#FF0000' title='点击即可实现复制' onClick='javascript:CopyText(this);'>{order_num=*}</font></td>
    <td>求购数量</td>
    <td>详细请根据入库模型自定义字段部分设置</td>
  </tr>
  <tr>
    <td><font color='#FF0000' title='点击即可实现复制' onClick='javascript:CopyText(this);'>{end_day=*}</font></td>
    <td>结束日期</td>
    <td>详细请根据入库模型自定义字段部分设置</td>
  </tr>
  <tr>
