...
<table width='100%' border='1' cellpadding='0' cellspacing='0' bordercolor='#99CCFF' >
  ...
  <tr>
    <td><font color='#FF0000' title='点击即可实现复制' onClick='javascript:CopyText(this);'>{maps=*}</font></td>
    <td>地图接口</td>
    <td>无默认值 </td>
  </tr>
  <tr>
    <td><font color='#FF0000' title='点击即可实现复制' onClick='javascript:CopyText(this);'>{my_price=*}</font></td>
    <td>价格</td>
    <td>详细请根据入库模型自定义字段部分设置</td>
  </tr>
  <tr>
    <td><font color='#FF0000' title='点击即可实现复制' onClick='javascript:CopyText(this);'>{my_rooms=*}</font></td>
    <td>室内布局</td>
    <td>详细请根据入库模型自定义字段部分设置</td>
  </tr>
  <tr>
    <td><font color='#FF0000' title='点击即可实现复制' onClick='javascript:CopyText(this);'>{my_peitao=*}</font></td>
    <td>配套设施</td>
    <td>详细请根据入库模型自定义字段部分设置</td>
  </tr>
  <tr>
    <td><font color='#FF0000' title='点击即可实现复制' onClick='javascript:CopyText(this);'>{my_acreage=*}</font></td>
    <td>室内面积</td>
    <td>详细请根据入库模型自定义字段部分设置</td>
  </tr>
  <tr>
    <td><font color='#FF0000' title='点击即可实现复制' onClick='javascript:CopyText(this);'>{my_floor=*}</font></td>
    <td>所在楼层</td>
    <td>详细请根据入库模型自定义字段部分设置</td>
  </tr>
  <tr>
    <td><font color='#FF0000' title='点击即可实现复制' onClick='javascript:CopyText(this);'>{my_jobs=*}</font></td>
    <td>招聘职位</td>
    <td>详细请根据入库模型自定义字段部分设置</td>
  </tr>
  <tr>
    <td><font color='#FF0000' title='点击即可实现复制' onClick='javascript:CopyText(this);'>{my_nums=*}</font></td>
    <td>招聘人数</td>
    <td>详细请根据入库模型自定义字段部分设置</td>
  </tr>
  <tr>
    <td><font color='#FF0000' title='点击即可实现复制' onClick='javascript:CopyText(this);'>{my_workplace=*}</font></td>
    <td>工作地区</td>
    <td>详细请根据入库模型自定义字段部分设置</td>
  </tr>
  <tr>
    <td><font color='#FF0000' title='点击即可实现复制' onClick='javascript:CopyText(this);'>{my_jobabout=*}</font></td>
    <td>职位技能要求</td>
    <td>详细请根据入库模型自定义字段部分设置</td>
  </tr>
  <tr>
